...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="first-slide" src="/imagenes/carr1.jpg" alt="First slide">
        ...
        <div class="item">
            <img class="second-slide" src="/imagenes/carr2.jpg" alt="Second slide">
        ...
        <div class="item">
            <img class="third-slide" src="/imagenes/carr3.jpg" alt="Third slide">
